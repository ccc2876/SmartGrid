...
def send_spatial_eu():
    ...
    print("Total Consump:", total_consump)
...
def receive_data_eu(max_buffer_size=5120):
    global NUM_SMART_METERS, DEGREE, ZP_SPACE
...
def main():
    ...
    # print(aggregator.get_spatial_counter())
    # if send_bill:
    #     for i in range(1, NUM_SMART_METERS + 1):
